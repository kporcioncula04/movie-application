...
export default class MovieCard extends Component {
  ...
  handleThumbsUp(){
    const {thumbsUp,movieData} = this.state
    const {Title,upVote} = movieData
    movieData.upVote = 0
    // console.log(movieData.val = 0)
   // console.log(movieData)
    this.setState({
      thumbsUp: this.state.thumbsUp + 1,
      movieData: this.state.movieData.upVote + 1
    })
    console.log(movieData)

    localStorage.setItem('thumbsUp', thumbsUp)

    localStorage.setItem(`${Title}thumbsUp`, upVote)

    // console.log(localStorage.Title)
    // if(!localStorage.Title){
    //   localStorage.setItem( `${Title}thumbsUp`, thumbsUp)
    // }
  ...
  componentDidMount() {
    axios
      ...
      // this.setState({
      //   thumbsUp : thumbsUpMovie
      // })

      // const thumbsUpp = Number(localStorage.getItem(`${Title}thumbsUp`))
      // console.log(thumbsUpp)
      // this.setState({thumbsUpp})
  ...
  render() {
    ...
    return (
      <div className="movie-card-container">
        ...
        <button onClick={(e) => this.handleThumbsUp(e)}> <svg width="3em" height="10em" viewBox="0 0 23 23" class="bi bi-hand-thumbs-up" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div style={{color: 'white'}}>
        <button onClick={(e) => this.handleThumbsDown(e)}>
        <svg width="3em" height="10em" viewBox="0 0 23 23" class="bi bi-hand-thumbs-down" fill="white" xmlns="http://www.w3.org/2000/svg">
